...
namespace WindowsFormsApplication1
{
    class Proforma
    {
        ...
        private PrintPreviewDialog verFactu;
        private PrintDocument factura;
        private PrintPreviewControl verfactu;
        ...
        private void sumarProducValorT()
        {
            ...
            double descuento = subtotal * this.valorDescuento;
            this.lb_valorDescuento.Text = descuento.ToString();
            double subT = subtotal - descuento;
            double iva = subT * this.valorIva;
            this.lb_valorIva.Text = iva.ToString();
            double total = subT + iva;
            this.lb_valorTotal.Text = total.ToString();
            getPoinInfoFactu();
        }
